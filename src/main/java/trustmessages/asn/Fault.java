...
public class Fault implements BerType, Serializable {
    ...
    public BerIA5String message = null;
    ...
    public Fault(BerInteger rid, BerIA5String message) {
        this.rid = rid;
    ...
    public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
        ...
        int codeLength = 0;
        codeLength += message.encode(reverseOS, true);
    ...
    public void appendAsString(StringBuilder sb, int indentLevel) {
        ...
        if (message != null) {
            ...
            sb.append("message: <empty-required-field>");
        }
