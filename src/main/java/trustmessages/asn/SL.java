...
public class SL implements BerType, Serializable {
    ...
    public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
        ...
        int codeLength = 0;
        codeLength += u.encode(reverseOS, true);

        codeLength += d.encode(reverseOS, true);
    ...
    public void appendAsString(StringBuilder sb, int indentLevel) {
        ...
        if (d != null) {
            ...
            sb.append("d: <empty-required-field>");
        }
        ...
        if (u != null) {
            ...
            sb.append("u: <empty-required-field>");
        }
